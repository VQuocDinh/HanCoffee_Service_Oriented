...
public class StaffAdapter extends RecyclerView.Adapter<StaffAdapter.StaffViewHolder> {
    ...
    public StaffAdapter(Context context, List<Staff> list, boolean showSpinnerForAdmin) {
...
//                                    break;
    ...
    public void onBindViewHolder(@NonNull StaffViewHolder holder, int position) {
        ...
        if(showSpinnerForAdmin && (staff.getRole() == 0 || staff.getRole() == 1)){
            ...
            if(staff.getId().equals(FirebaseAuth.getInstance().getCurrentUser().getUid())){
                holder.imgBtnSaveRole.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Toast.makeText(context, "Bạn không thể thay đổi quyền của chính mình", Toast.LENGTH_SHORT).show();
                    }
                });
            } else {
                holder.imgBtnSaveRole.setOnClickListener(new View.OnClickListener() {
    ...
    private String getUserRole(Staff staff) {
        switch (staff.getRole()) {
            case 0:
                return "Admin";
//            case 1:
...
//                break;
    ...
    private void updateRoleInFirebase(Staff emailStaff, String selectedRole) {
